...
public class Sort extends Iterator implements GlobalConst {
     ...
     *
     * @param sortMemSize
     *            the size the memory used for internal sorting. For simplicity,
     *            you can assume it is in the unit of tuples.
     * @param bufSize
     *            the total buffer size for the merging phase in the unit of
     *            page.
     */
    ...
    public void explain(int depth) {
        FileScan fs = new FileScan(iter.schema, file);
        fs.explain(depth);
